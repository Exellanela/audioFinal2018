...
public class Sound : MonoBehaviour {
    //WILL EDIT LATER I'M SORRY
    //honestly will probably try using mixers instead
	...
	public void PlaySound(AudioClip snd, float vol, float pitch = 1f) {
		int sNum = GetSourceNum ();
		audSources [sNum].clip = snd;
		audSources [sNum].volume = vol;
        audSources[sNum].pitch = 1f;
